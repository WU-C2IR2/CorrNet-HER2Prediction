...
class ResNeXtClassifier(pl.LightningModule):
    def __init__(self, num_classes=4, learning_rate=0.0001, hidden_layer=16, class_weights = None):
...
checkpoint_callback = ModelCheckpoint(
    ...
    monitor="val_acc",
    mode="max",
    dirpath="/ceph/chpc/home-nfs/d.kaushik/Vision_Transformer/Classification/correlated_representations/saved_weights/resnext/new/",
    filename="resnext_finetune_all_layer-{epoch:02d}-{val_acc:.2f}-{val_loss:.2f}"+"__"+str(args.hidden_layer)
)        
...
efficientnet_model = ResNeXtClassifier(num_classes=4, learning_rate=0.0001, hidden_layer = args.hidden_layer, class_weights = class_weights_tensor)
