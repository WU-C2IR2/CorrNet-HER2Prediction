...
class EfficientNetClassifier(pl.LightningModule):
    def __init__(self, num_classes=4, learning_rate=0.0001):
        ...
        self.model = timm.create_model('efficientnet_b0', pretrained=False, num_classes = num_classes, in_chans = 6)
...
checkpoint_callback = ModelCheckpoint(
    ...
    monitor="val_acc",
    mode="max",
    dirpath="/ceph/chpc/home-nfs/d.kaushik/Vision_Transformer/Classification/correlated_representations/saved_weights/efficientnet_na/new/",
    filename="efficientnet_finetune_all_layer-{epoch:02d}-{val_loss:.2f}"+"__"+str(args.hidden_layer)
)        
