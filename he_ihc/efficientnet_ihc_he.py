...
checkpoint_callback = ModelCheckpoint(
    ...
    monitor="val_acc",
    mode="max",
    dirpath="/ceph/chpc/home-nfs/d.kaushik/Vision_Transformer/Classification/he_ihc/saved_weights/EfficientNet_Scratch/new/",
    filename="efficientnet_normal_ce-{epoch:02d}-{val_loss:.2f}-{val_acc:.2f}"
)
