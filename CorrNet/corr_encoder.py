###### Kaushik Dutta
###### Implementation of Corr-AE or Correlational AutoEncoder (Attention Module included)
...
from model_corr_encoder import CorrNet_3Layer
...
class Training_CorrNet(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        ##For autoencoder
        z_recon, x_att, y_att, hidden = self(he, ihc)
        loss,l1,l2,l3,l4 = self.criterion(z_recon, x_att, y_att, he, ihc)
